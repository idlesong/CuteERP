...
ActiveRecord::Schema.define(:version => 20160720042000) do
  ...
  create_table "opportunities", :force => true do |t|
    t.string   "priority"
    t.string   "project_type"                          # markets, solutions
    t.string   "solution"                              # solution NewOpportunity/EvaluationSample/DesignIn/DesignWin
    t.string   "note"                                  # solution: SCT2400; DI blockings:
    t.datetime "created_at",   :null => false
    t.datetime "updated_at",   :null => false
    t.integer  "customer_id"
  end
...
## "forecast_orders"
  ...
  create_table "tasks", :force => true do |t|                      # activities
    t.string   "description"
    t.string   "status"
    t.datetime "created_at",    :null => false
    t.datetime "updated_at",    :null => false
    t.integer  "oppostatus_id"                                     # related opportunites
  end
